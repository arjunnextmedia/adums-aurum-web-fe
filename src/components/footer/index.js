  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const scrolledToBottom =
        Math.ceil(windowHeight + scrollTop) >= documentHeight - 10;
              ...
              <div className="widget about-widget">
                <div className="logo widget-title">
                  <Link onClick={ClickHandler} className="logo" to="/">
                    <img src={Logo} alt="ADAMS AURUM LOGO" />
                  </Link>
                </div>
                <p>
                  Adams Aurum – your trusted bullion partner, offering 99.99%
                  pure gold with guaranteed authenticity and long-term value.
                </p>
                <ul>
                  <li>
                ...
                <div className="contact-ft">
                  <ul>
                    ...
                    <li>
                      ...
                      <a href="tel:+97142979110">
                        +971 4 297 9110 <span> - Landline</span>
                      </a>
                    ...
                    <li>
                      ...
                      <a href="mailto:info@adamsaurum.com">
                        {" "}
                        info@adamsaurum.com{" "}
                      </a>
                    </li>
        ...
        <div className="container">
          <div className="row">
            <div className="col col-xs-12">
              <ul>
                <li>
                  &copy; 2025 ADAMS AURUM. Design By{" "}
                  <Link
                    onClick={ClickHandler}
                    to="https://nextmedia.ae/"
                    target="_blank"
                    style={{ color: "#CAAB06" }}
                  >
                    Next Media
                ...
                <li>
                  <Link onClick={ClickHandler} to="/terms-of-use">
                    Terms of use |
                  </Link>{" "}
